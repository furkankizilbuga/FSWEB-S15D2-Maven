...
public class StringSet {
    ...
    public static Set<String> findUniqueWords(List<String> texts) {
        ...
        for (String word : words) {
            if(!word.isEmpty()) uniques.add(word.toLowerCase());
        }
    ...
    public static Set<String> findUniqueWords() {
        ...
        Set<String> uniques = new TreeSet<>(Arrays.asList(words));
